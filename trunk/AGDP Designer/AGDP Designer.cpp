...
CAGDPDesignerApp::CAGDPDesignerApp()
{
	...
	SetAppID(_T("AGDP Designer.AppID.NoVersion"));

	// TODO: 在此加入建構程式碼，
	// 將所有重要的初始設定加入 InitInstance 中
}

// 僅有的一個 CAGDPDesignerApp 物件

CAGDPDesignerApp theApp;


// CAGDPDesignerApp 初始設定

BOOL CAGDPDesignerApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_AGDPDesignerTYPE,
...
int CAGDPDesignerApp::ExitInstance()
{
	// TODO: 處理其他您已經加入的資源
	AfxOleTerm(FALSE);
	//CleanState();
...
// 執行對話方塊的應用程式命令
void CAGDPDesignerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CAGDPDesignerApp 自訂載入/儲存方法

void CAGDPDesignerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CAGDPDesignerApp::LoadCustomState()
{
}

void CAGDPDesignerApp::SaveCustomState()
{
}

void CAGDPDesignerApp::OnFileNew()
{
	CWinApp::OnFileNew();
}
