...
int D3DApp::run()
{
    ...
    while(msg.message != WM_QUIT)
    {
        ...
        else
        {
            ...
            if(InputStateS::instance().isKeyDown(KEY_NUMPADPLUS))
            {
                ratio *= 2;
				printf("Game Speed Ratio %.2f\n", ratio);
            }
            else if(InputStateS::instance().isKeyDown(KEY_NUMPADMINUS))
            {
                ratio *= 0.5;
				printf("Game Speed Ratio %.2f\n", ratio);
            }
            ...
            if(!m_AppPaused)
            {
                UpdateScene(m_Timer.getDeltaTime()*ratio);
            }
            else
            {
                Sleep(1);
