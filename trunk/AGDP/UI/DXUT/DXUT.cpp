                          ...
                          bool bForceRecreate, bool bClipWindowToSingleAdapter )
{
	...
	if ( bNeedToResize )
	{
		                ...
		                nClientHeight != DXUTGetBackBufferHeightFromDS( pNewDeviceSettings ) )
		{
			...
			else { deviceSettings.d3d11.sd.BufferDesc.Width = 0; }

			if ( DXUTIsD3D9( &deviceSettings ) ) { deviceSettings.d3d9.pp.BackBufferHeight = 0; }
			else { deviceSettings.d3d11.sd.BufferDesc.Height = 0; }
...
void DXUTRender3DEnvironment11()
{
	...
	if ( !GetDXUTState().GetRenderingPaused() )
	{
		...
		{
			GetClientRect( DXUTGetHWND(), &rcClient );
			int w = DXUTGetDXGIBackBufferSurfaceDesc()->Width;
			int h = DXUTGetDXGIBackBufferSurfaceDesc()->Height;
...
//
// HRESULT WINAPI DXUTSetD3D11Device( ID3D11Device* pd3dDevice)
// {
// 	HRESULT hr;
//
// 	if( pd3dDevice == NULL )
...
//
// 	// Fill out the rest of the device settings struct
// 	DeviceSettings.d3d11.AdapterOrdinal = d3dCreationParams.AdapterOrdinal;
// 	DeviceSettings.d3d11.DriverType = d3dCreationParams.DeviceType;
// 	DXUTFindD3D9AdapterFormat( DeviceSettings.d3d11.AdapterOrdinal, DeviceSettings.d3d11.DeviceType,
// 		DeviceSettings.d3d11.pp.BackBufferFormat, DeviceSettings.d3d11.pp.Windowed,
// 		&DeviceSettings.d3d11.AdapterFormat );
// 	DeviceSettings.d3d9.BehaviorFlags = d3dCreationParams.BehaviorFlags;
//
// 	// Change to the Direct3D device passed in
// 	hr = DXUTChangeDevice( &DeviceSettings, pd3dDevice,  NULL, false, false );
