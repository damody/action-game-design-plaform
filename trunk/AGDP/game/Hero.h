...
private:
	...
	AABB3D<Hero*>		m_BodyAABB;
	AABB3D<Hero*>		m_AttackAABB;
	AABB3D<Hero*>		m_CatchAABB;
...
{
	AABB3D<Hero*>& operator()(Hero* hero){return (hero->GetBodyAABB());}
};

struct GetAttackAABB3D
{
	AABB3D<Hero*>& operator()(Hero* hero){return (hero->GetAttackAABB());}
};

struct GetCatchAABB3D
{
	AABB3D<Hero*>& operator()(Hero* hero){return (hero->GetCatchAABB());}
};
